	...
	<div class="section_content">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 left col-sm-6 left">
							<h3><?php
								$idObj = get_category_by_slug('s_rab');
								$id = $idObj->term_id;
				...
				<div class="col-md-6 col-sm-6 right">
							<h3><?php
								$idObj = get_category_by_slug('s_edu');
								$id = $idObj->term_id;
								echo get_cat_name($id) ?></h3>
		...
		<div class="container">
			<div class="row">
				<div class="filter_div controls">
					...
					<li class="filter" data-filter=".sites">Сайт 1</li>
					<li class="filter" data-filter=".sites2">Сайт 2</li>
					<li class="filter" data-filter=".sites3">Сайт 3</li>
				</ul>
				</div>
			...
			<div class="hidden">
				<div class="podrt_descr">
					...
					<h3>Заголовок работы</h3>
						<?php the_content();?>
						<img src="<?php $large_image_url = wp_get_attachment_image_src( get_post_thumbnail_id(), 'large' ); echo $large_image_url[0];?>" alt="<?the_title();?>"/>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="section_content">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 col-sm-6">
					<form action="http://formspree.io/haponov1819@gmail.com" class="main_form" novalidate target="_blank" method="post">
					<div class="control-group">
						...
						<label class="form-group">
							...
							<input type="email" name="email" placeholder="Ваш E-mail" data-validation-email-message="Не корректно введен E-mail" required />
							<p class="help-block text-danger"></p>
						</label>
						<label class="form-group">
