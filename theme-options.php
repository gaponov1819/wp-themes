...
function theme_options_add_page() {
	add_theme_page( __( 'Настройка нашей темы', 'sampletheme' ), __( 'Настройка нашей темы', 'sampletheme' ), 'edit_theme_options', 'theme_options', 'theme_options_do_page' );
}
